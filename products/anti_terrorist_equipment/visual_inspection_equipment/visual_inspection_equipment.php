...
<head>
    ...
    <link rel="stylesheet" href="visual_inspection_equipment.css">
...
<div class="container">
    <div class="row">
        <div class="col">
            <ul class="custom-square-list" style="list-style-type: none;">
                <strong>
                <li><a href="/site/products/equipment_for_searching/equipment.php">АППАРАТУРА ПОИСКА ТЕХНИЧЕСКИХ СРЕДСТВ РАЗВЕДКИ</a></li>
                </strong>
                <strong><li><a href="/site/products/information_security/security_technology.php">ТЕХНИКА ЗАЩИТЫ ИНФОРМАЦИИ</a></li></strong>
                <strong><li><a href="/site/products/anti_terrorist_equipment/anti_terrorist.php">АНТИТЕРРОСТИСТИЧЕСКОЕ И ДОСМОТРОВОЕ ОБОРУДОВАНИЕ</a></li></strong>
                <div>
                        <ul class="list">
                            <div class="undertext">
                            <li class="list-item"><a href="/site/products/anti_terrorist_equipment/explosive_device_detection/explosive_device_detection.php">Обнаружение взрывных устройств</a></li>
                            <li class="list-item"><a href="/site/products/anti_terrorist_equipment/bomb_protection/bomb_protection.php">Защита от взрывных устройств</a></li>
                            <li class="list-item"><a href="/site/products/anti_terrorist_equipment/visual_inspection_equipment/visual_inspection_equipment.php">Средства визуального досмотра</a></li>
                            <li class="list-item"><a href="/site/products/anti_terrorist_equipment/technical_endoscopes/technical_endoscopes.php">Технические эндоскопы</a></li>
                            <li class="list-item"><a href="/site/products/anti_terrorist_equipment/handheld_metal_detectors/handheld_metal_detectors.php">Ручные металлодетекторы</a></li>
                            <li class="list-item"><a href="/site/products/anti_terrorist_equipment/arch_metal_detectors/arch_metal_detectors.php">Арочные металлодетекторы</a></li>
                            <li class="list-item"><a href="/site/products/anti_terrorist_equipment/xray_television/xray_television.php">Рентгенотелевизионные комплексы</a></li>
                            <li class="list-item"><a href="/site/products/anti_terrorist_equipment/baggage_and_cargo/baggage_and_cargo.php">Установки для досмотра багажа и грузов</a></li>
                            </div>
                        </ul>
                    </div>
                <strong><li><a href="/site/products/selena/selena.php">МНОГОКАНАЛЬНЫЙ КОМПЛЕКС АУДИОЗАПИСИ SELENA</a></li></strong>
                <strong><li><a href="/site/products/portative_dictophone/dictophons.php">ПОРТАТИВНЫЕ ДИКТОФОНЫ И ВИДЕОРЕГИСТРАТОРЫ</a></li></strong>
            </ul>
        </div>
    </div>
</div>
            <!------Продукция---------->
                <div class="products-container">
                    ...
                    $subcategory_id = 22; // ID подкатегории "Обнаружители скрытых видеокамер"
