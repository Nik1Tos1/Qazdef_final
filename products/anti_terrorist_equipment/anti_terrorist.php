...
<head>
    ...
    <link rel="stylesheet" href="anti_terrorist.css">
    ...
    <div class="row">
            <div class="col">
                <ul class="custom-square-list">
                    ...
                    <li><a href="/site/products/information_security/security_technology.php">ТЕХНИКА ЗАЩИТЫ ИНФОРМАЦИИ</a></li>
                    ...
                    <li><a href="/site/products/portative_dictophone/dictophons.php">ПОРТАТИВНЫЕ ДИКТОФОНЫ И ВИДЕОРЕГИСТРАТОРЫ</а></li>
                </ul>
            </div>
    <aside class="content">
        <h1>АНТИТЕРРОСТИСТИЧЕСКОЕ И ДОСМОТРОВОЕ ОБОРУДОВАНИЕ</h1>
        <ul>
            <ul>
                <li><a href="/site/products/anti_terrorist_equipment/explosive_device_detection/explosive_device_detection.php">Обнаружение взрывных устройств</a></li>
                <li><a href="/site/products/anti_terrorist_equipment/bomb_protection/bomb_protection.php">Защита от взрывных устройств</a></li>
                <li><a href="/site/products/anti_terrorist_equipment/visual_inspection_equipment/visual_inspection_equipment.php">Средства визуального досмотра</a></li>
                <li><a href="/site/products/anti_terrorist_equipment/technical_endoscopes/technical_endoscopes.php">Технические эндоскопы</li>
                <li><a href="/site/products/anti_terrorist_equipment/handheld_metal_detectors/handheld_metal_detectors.php">Ручные металлодетекторы</a></li>
                <li><a href="/site/products/anti_terrorist_equipment/arch_metal_detectors/arch_metal_detectors.php">Арочные металлодетекторы</a></li>
                <li><a href="/site/products/anti_terrorist_equipment/xray_television/xray_television.php">Рентгенотелевизионные комплексы</li>
                <li><a href="/site/products/anti_terrorist_equipment/baggage_and_cargo/baggage_and_cargo.php">Установки для досмотра багажа и грузов</a></li>
            </ul>
        </li>
    </ul>
  </aside>
