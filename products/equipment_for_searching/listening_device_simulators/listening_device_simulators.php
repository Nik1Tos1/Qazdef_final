...
<head>
    ...
    <link rel="stylesheet" href="listening_device_simulators.css">
        ...
        <div class="row">
            <div class="col">
                <ul class="custom-square-list">
                    <strong>
                    <li><a href="">АППАРАТУРА ПОИСКА ТЕХНИЧЕСКИХ СРЕДСТВ РАЗВЕДКИ</a></li>
                    </strong>
                    <div>
                        <ul class="list">
                            <div class="undertext">
                                <li class="list-item"><a href="/site/products/equipment_for_searching/camera_detectors/hidden_camera_detectors.php">Обнаружители скрытых видеокамер</a></li>
                                <li class="list-item"><a href="/site/products/equipment_for_searching/linear_locator/linear_locator.php">Нелинейные локаторы</a></li>
                                <li class="list-item"><a href="/site/products/equipment_for_searching/multifunctional_search_devices/search_devices.php">Многофункциональные поисковые приборы</a></li>
                                <li class="list-item"><a href="/site/products/equipment_for_searching/radio_equipment/radio_equipment.php">Аппаратура радиомониторинга</a></li>
                                <li class="list-item"><a href="/site/products/equipment_for_searching/line_inspection_equipment/line_inspection_equipment.php">Аппаратура обследования проводных линий</a></li>
                                <li class="list-item"><a href="/site/products/equipment_for_searching/listening_device_simulators/listening_device_simulators.php">Имитаторы подслушивающих устройств</a></li>
                                <li class="list-item"><a href="/site/products/equipment_for_searching/search_receivers/search_receivers.php">Поисковые приемники</a></li>
                                <li class="list-item"><a href="/site/products/equipment_for_searching/field_indicators/field_indicators.php">Индикаторы поля</a></li>
                            </div>
                        </ul>
                    </div>
                    <strong>
            ...
            <!------Продукция---------->
                <div class="products-container">
                    ...
                    $subcategory_id = 6; // ID подкатегории "Обнаружители скрытых видеокамер"
