...
<head>
    ...
    <link rel="stylesheet" href="speech_information_protection.css">
    ...
    <div class="row">
            <div class="col">
                <ul class="custom-square-list">
                    ...
                    <div>
                        <ul class="list">
                            <div class="undertext">
                            <li class="list-item"><a href="/site/products/information_security/recording_suppressors/recording_suppressors.php">Подавители записи диктофонов и микрофонов</a></li>
                            <li class="list-item"><a href="/site/products/information_security/communication_blockers/communication_blockers.php">Блокираторы связи и каналов передачи данных</a></li>
                            <li class="list-item"><a href="/site/products/information_security/mobile_security/mobile_security.php">Защита сотовых телефонов</a></li>
                            <li class="list-item"><a href="/site/products/information_security/power_protection/power_protection.php">Защита сетей электропитания</a></li>
                            <li class="list-item"><a href="/site/products/information_security/protection_of_lines/protection_of_lines.php">Защита проводных и телефонных линий</a></li>
                            <li class="list-item"><a href="/site/products/information_security/pemi_chiffon/pemi_chiffon.php">Система защиты по каналам ПЭМИ и наводок в линии SEL 111 «Шифон»</a></li>
                            <li class="list-item"><a href="/site/products/information_security/sonet/sonet.php">Система защиты по виброакустическому и акустоэлектрическому каналам SEL-155 «Сонет»</a></li>
                            <li class="list-item"><a href="/site/products/information_security/shagren/shagren.php">Система защиты по виброакустическому и оптикоэлектронному каналам SEL SP-157 «Шагрень»</a></li>
                            <li class="list-item"><a href="/site/products/information_security/shluz/shluz.php">Удаленное управление системами защиты «Шлюз»</a></li>
                            <li class="list-item"><a href="/site/products/information_security/erasing_devices/erasing_devices.php">Устройства стирания информации</a></li>
                            <li class="list-item"><a href="/site/products/information_security/speech_information_protection/speech_information_protection.php">Комплексы оценки эффективности защиты речевой информации</a></li>
                            </div>
                        </ul>
                    </div>
                    <strong>
            ...
            <!------Продукция---------->
                <div class="products-container">
                    ...
                    $subcategory_id = 19; // ID подкатегории "Обнаружители скрытых видеокамер"
